...
external_stylesheets = ['https://github.com/vinayreddy115/vinay.github.io/blob/master/learn.css']
...
df = pd.read_csv('D:/USF MS BAIS CourseWork/Sem-2/Data Visualization/Data.csv')
df2 = df
